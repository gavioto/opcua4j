...
public class ReferenceTypeElementParser extends AbstractElementParser {

	private static final Logger LOG = Logger
			.getLogger(ReferenceTypeElementParser.class);
	...
	public ParsedElement parseElement(Element elem, INodeIDs nodeIds,
		...
		if (nodeId != null) {
			...
			boolean isSymmetric = readIsSymmetric();
			String inverseName = readInverseName();

			Node newNode = NodeFactory.getReferenceTypeNodeInstance(browseName,
					"description goes here", browseName, locale, nodeId, isAbstract, isSymmetric, inverseName);
