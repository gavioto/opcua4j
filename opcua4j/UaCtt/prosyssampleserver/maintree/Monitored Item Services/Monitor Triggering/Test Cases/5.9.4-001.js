/*  Test 5.9.4 Test #1 prepared by Anand Taparia; ataparia@kepware.com
    Description:
        Specify valid subscriptionId and triggeringItemId , and one valid linksToAdd.
    ...
    else
    {
        ...
        for( i = 0; i< numItemsToMonitor; i++ )
        {
            ...
            switch(i)
            {
                ...
                // item to link
                default:
                    addError( "Error in script: 'default' encountered in switch which was not expected" );
            }
        }
...
safelyInvoke( setTriggering594001 );