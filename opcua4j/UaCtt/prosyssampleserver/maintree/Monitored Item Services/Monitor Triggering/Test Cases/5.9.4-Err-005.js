/*    Test 5.9.4 Error Test 5 prepared by Anand Taparia; ataparia@kepware.com
      Description:
        Script specifies invalid linksToRemove.
    ...
    else
    {
        ...
        if ( uaStatus.isGood() )
        {
            ...
            if( uaStatus.isGood() )
            {
                ...
                setTriggeringRequestToRemove.LinksToRemove [0] = createMonitoredItemsResponse.Results[1].MonitoredItemId + 0x1234;
...
safelyInvoke( setTriggering594Err005 );