/*  Test 5.9.1 Test 16; prepared by Nathan Pocock; nathan.pocock@opcfoundation.org
    Description:
...
function createMonitoredItems591016()
{
    ...
    GenerateScalarValue( valuesToWrite[0], nodeSetting.datatype, 17 );
    GenerateScalarValue( valuesToWrite[1], nodeSetting.datatype, 18 );
...
safelyInvoke(createMonitoredItems591016 );