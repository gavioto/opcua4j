/*  Test 5.9.1 Test 17; prepared by Nathan Pocock; nathan.pocock@opcfoundation.org
    Description:
        CreateMonitoredItems uses the following parameter values:
            ...
            QUEUE  = 1;
            TIMES  = TimestampsToReturn.Neither;
        Expected to succeed.
...
function createMonitoredItems591017()
{
    ...
    GenerateScalarValue( valuesToWrite[0], nodeSetting.datatype, 19 );
    GenerateScalarValue( valuesToWrite[1], nodeSetting.datatype, 20 );
...
safelyInvoke( createMonitoredItems591017 );