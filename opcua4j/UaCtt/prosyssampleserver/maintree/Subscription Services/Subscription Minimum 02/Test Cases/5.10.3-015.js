/*  Test 5.10.3 Test 15, prepared by Nathan Pocock; nathan.pocock@opcfoundation.org
    ...
    Description:
        ...
        Verify both subscriptions are returning data.
        Disable 1 subscription.
...
function setPublishingMode593015()
{
    ...
    if( setPublishing.Execute( subscriptions, false ) )
    {
        ...
        {
            GenerateScalarValue( allItems[i].Value.Value, allItems[i].DataType, 15 );
        }
...
safelyInvoke( setPublishingMode593015 );