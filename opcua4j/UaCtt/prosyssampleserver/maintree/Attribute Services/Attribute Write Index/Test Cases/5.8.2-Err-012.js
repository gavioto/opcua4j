/*  Test 5.8.2 Error Test 12; prepared by Nathan Pocock; nathan.pocock@opcfoundation.org

    Description:
        Write to Invalid by means of invalid syntax of IndexRange "2-3" of a Node.
...
function write582Err012()
{
            ...
            switch( dataTypeNodeNames[i] )
            {
               ...
               case "/Server Test/NodeIds/Static/All Profiles/Arrays/SByte":
                ...
                case "/Server Test/NodeIds/Static/All Profiles/Arrays/ByteString":
                    ...
                    arrayWriteValues[0] = UaByteString.fromHexData( "0x5A6970" );
                    arrayWriteValues[1] = UaByteString.fromHexData( "0x5A6170" );
                ...
                case "/Server Test/NodeIds/Static/All Profiles/Arrays/Guid":
                    ...
                    arrayWriteValues[1] = new UaGuid( "{0E617567-FAFC-32BD-BD4D-BE89B905580D}" );
    ...
    if( uaStatus.isGood() )
    {
        checkWriteError( writeReq, writeRes, expectedResults, false, undefined, OPTIONAL_CONFORMANCEUNIT );
