/*
    Description:
        Validates the DeleteMonitoredItems() FAILED response by analyzing the parameters.
...
// Request is of Type UaDeleteMonitoredItemsRequest
// Response is of Type UaDeleteMonitoredItemsReponse
// ExpectedServiceResult is object of type ExpectedAndAcceptedResults (defined in Base/Objects/expectedResults.js)
function checkDeleteMonitoredItemsFailed( Request, Response, ExpectedServiceResults )
{
    // check in parameters
    if( arguments.length !== 3 )
    {
        addError( "function checkDeleteMonitoredItemsFailed(Request, Response, ExpectedServiceResults): Number of arguments must be 3" );
        return( false );
    }
