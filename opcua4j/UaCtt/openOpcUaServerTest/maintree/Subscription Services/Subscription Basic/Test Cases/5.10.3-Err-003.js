...
function setPublishingMode5103Err003()
{
    var subscriptions = [ 
        new Subscription(), 
        new Subscription() ];
    ...
    for( i=0; i<subscriptions.length; i++ )
    {
        if( createSubscription( subscriptions[i], g_session ) )
        {
            ...
            //var items = new MonitoredItem( UaNodeId.fromString( readSetting( "/Server Test/NodeIds/Static/All Profiles/Scalar/Int32" ).toString() ), 0x0 );
    ...
    if( setPublishing.Execute( invalidSubscriptions, false, expectedResults, true ) )
    {
...
safelyInvoke( setPublishingMode5103Err003 );