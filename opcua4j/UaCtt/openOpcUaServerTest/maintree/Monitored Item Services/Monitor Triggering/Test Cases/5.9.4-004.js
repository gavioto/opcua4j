/*    Test 5.9.4 Test 4 prepared by Anand Taparia; ataparia@kepware.com
      Description:
          Script does multiple LinksToRemove where each link was previously 
          added in linksToAdd.
...
{
    var items = MonitoredItem.createMinimumMonitoredItemsFromSettings( NodeIdSettings.ScalarStaticAll(), 5 );
            ...
            if( checkCreateMonitoredItemsValidParameter( createMonitoredItemsRequest, createMonitoredItemsResponse ) )
            {
                ...
                if( uaStatus.isGood() )
                {
                    if( checkSetTriggeringValidParameter( setTriggeringRequest, setTriggeringResponse ) )
                    {
                        ...
                        setTriggeringRequestToRemove.LinksToRemove [1] = createMonitoredItemsResponse.Results[2].MonitoredItemId;
                        setTriggeringRequestToRemove.LinksToRemove [2] = createMonitoredItemsResponse.Results[3].MonitoredItemId;
...
safelyInvoke( setTriggering594004 );