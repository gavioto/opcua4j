/*  Test 5.9.1 Test 57 prepared by Anand Taparia; ataparia@kepware.com
    Description:
        Script creates a MonitoredItem of type StringArray with IndexRange of “1:2,2:3”.
...
function createMonitoredItems591057()
{
    ...
    if( nodeId === null )
    {
        addSkipped( "String array not defined in setting: " + nodeSetting );
        return;
    }
...
safelyInvoke( createMonitoredItems591057 );