/*  Test 5.9.2 Test 4, prepared by Nathan Pocock; nathan.pocock@opcfoundation.org
...
function test592004( timestamps )
{
    ...
    else
    {
        ...
        createMonitoredItemsRequest.TimestampsToReturn = TimestampsToReturn.Neither;
        ...
        if ( uaStatus.isGood() )
        {
            ...
            {
                publishService.ValidateTimestampsInAllDataChanges( modifyMonitoredItemsRequest.TimestampsToReturn );
            }
...
function modifyMonitoredItem592004()
{
    test592004( TimestampsToReturn.Both );
}

safelyInvoke( modifyMonitoredItem592004 );