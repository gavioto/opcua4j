/*  Test 5.9.3 Test 2 prepared by Anand Taparia; ataparia@kepware.com
    Description:
        Script sets monitoring mode to 'Sampling' for a 'Disabled' monitor item. 
        Calls publish each time to verify that no notifications were received.

    Revision History
        06-Oct-2009 AT: Initial version
        07-Oct-2009 AT: Refactored script into safelyInvoke();
        18-Nov-2009 NP: Revised to use the Publish object.
                        REVIEWED.
*/
...
safelyInvoke( setMonitoringMode593002 );