/*
    Description:
        Validates the DeleteSubscription() response by analyzing the parameters.
...
function checkDeleteSubscriptionsValidParameter( Request, Response )
{
    var bSucceeded = true;
    // check in parameters
    if( arguments.length !== 2 )
    {
        addError( "function checkDeleteSubscriptionsValidParameter(Request, Response): Number of arguments must be 2!" );
        return false;
    }
