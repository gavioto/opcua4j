/*    Test 5.9.4 Test 2 prepared by Anand Taparia; ataparia@kepware.com
      Description:
          Script adds multiple items as LinksToAdd.
          We expect all calls to succeed.
...
function setTriggering594002()
{
    ...
    if( items === null || items.length === 0 || numItemsToMonitor > items.length )
    {
...
safelyInvoke( setTriggering594002 );