/*  Test 5.8.1 Error Test 27; prepared by Nathan Pocock; nathan.pocock@opcfoundation.org

    Description:
        Read a Node of each basic core Array data type. Specify an IndexRange that is 
        invalid, i.e. "5:2" (backwards).
    ...
    Revision History
        ...
        07-Jul-2010 DP: Replaced call to readArray581026() with readArray581Err027().

     FOR MORE INFORMATION ABOUT THIS AND OTHER TEST CASES, PLEASE REVIEW:
         Test Lab Specifications Part 8 - UA Server Section 5.8.1.
*/

function readArray581Err027( nodeSetting, nodeType )
{
...
function read581Err027()
{
    ...
    {
        readArray581Err027( items[i], NodeIdSettings.guessType( items[i].NodeSetting ) );
    }
}

safelyInvoke( read581Err027 );