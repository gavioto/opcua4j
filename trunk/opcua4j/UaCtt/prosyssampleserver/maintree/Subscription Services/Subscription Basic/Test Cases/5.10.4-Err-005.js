/*  Test 5.10.4 Error Test 5, prepared by Nathan Pocock; nathan.pocock@opcfoundation.org
    Description:
        Acknowledge multiple invalid sequence numbers from an invalid subscription.
        ServiceResult = Good.
    ...
    Revision History
        ...
        23-Mar-2011 NP: Switched to STATIC node. Now writes a value to control the dataChange(s).
*/
...
safelyInvoke( publish5104Err005 );