/*  Test 5.8.1 Error Test 10; prepared by Mark Rice; mrice@canarylabs.com

    Description:
        Read valid attributes (ids: 1, 3, 4, 5) from multiple nodes with
...
function read591Err010()
{
    ...
    for( var i=0; i<invalidNodeNames.length; i++ )
    {
        ...
        var settingValue = readSetting( invalidNodeNames[i] );
