/*  Test 5.8.1 Test 8; prepared by Mark Rice mrice@canarylabs.com

    Description:
        Read a data value with timestampsToReturn = SERVER.
...
function read581008()
{
    ...
    readReq.TimestampsToReturn = TimestampsToReturn.Server;
