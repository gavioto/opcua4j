/*
    Description:
        Validates the Republish() response by analyzing the parameters.
...
// Request is of Type UaRepublishRequest
// Response is of Type UaRepublishResponse
...
function checkRepublishFailed( Request, Response, ExpectedServiceResults )
{
    ...
    {
        addError( "function checkRepublishFailed(Request, Response, ExpectedServiceResults): Number of arguments must be 3" );
        return( false );
    }
